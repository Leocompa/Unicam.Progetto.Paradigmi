...
public class RepositoryExample : IProject
{
    public void RunProject()
    {
        ...
        foreach (var riga in elenco)
        {
            ...
            {
                Console.WriteLine("-- " + portate.Quantita + " x " + portate.PortataNome + " = " +
                                  portateOrdinateService.GetCostoPortata(portate.OrdinazioneId, portate.PortataNome));
            }
        }
        ...
        Console.WriteLine(
            "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
        var elencoUtente = ordineService.GetStoricoOrdini(0, 10, nuovoUtente.Ruolo,
            DateOnly.FromDateTime(DateTime.Now.AddDays(-1)), null, nuovoUtente.Email, out totalNum);
